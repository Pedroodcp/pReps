...
public class Project extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (getConfig().getBoolean("Database.mysql") == isEnabled()) {
            ...
            Bukkit.getConsoleSender().sendMessage("§a[Project] Sistema carregado com sucesso!");
    ...
    public void onDisable() {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage("");
            Bukkit.getConsoleSender().sendMessage("§c[Project] Sistema desativado com sucesso.");
            Bukkit.getConsoleSender().sendMessage("§7Armazenamento: §aSalvo");
            Bukkit.getConsoleSender().sendMessage("");
        } catch (SQLException e) {
            Bukkit.getConsoleSender().sendMessage("");
            Bukkit.getConsoleSender().sendMessage("§c[Project] Sistema desativado com erro no armazenamento.");
